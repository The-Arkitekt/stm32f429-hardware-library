...
typedef enum
{
	...
	DMA_STREAM_CHANNEL_7 = DMA_STREAM_CR_CHSEL_MSK
}dma_stream_channel_enum;

typedef enum
{
	DMA_STREAM_FLOW_CONTROL_DMA        = 0U,
	DMA_STREAM_FLOW_CONTROL_PERIPHERAL = DMA_STREAM_CR_PFCTRL_MSK,
...
typedef enum
{
	...
	DMA_STREAM_PRIORITY_VERYHIGH = DMA_STREAM_CR_PL_MSK
}dma_stream_priority_enum;

typedef enum
{
	DMA_STREAM_FIFO_DIRECT_MODE_ENABLE  = 0U,
	DMA_STREAM_FIFO_DIRECT_MODE_DISABLE = DMA_STREAM_FCR_DMDIS_MSK,
...
typedef enum
{
	...
	DMA_STREAM_FIFO_THRESHOLD_FULL         = DMA_STREAM_FCR_FTH_MSK
}dma_stream_fifo_threshold_enum;

typedef enum
{
	DMA_STREAM_FIFO_ERROR_INTERRUPT_DISABLE = 0U,
	DMA_STREAM_FIFO_ERROR_INTERRUPT_ENABLE  = DMA_STREAM_FCR_FEIE_MSK
...
typedef enum
{
	...
	DMA_STREAM_PERIPHERAL_INCREMENT_MODE = DMA_STREAM_CR_PINC_MSK
...
typedef enum
{
	...
	DMA_STREAM_PERIPHERAL_BURST_INCR16 = DMA_STREAM_CR_PBURST_MSK
...
typedef enum
{
	...
	DMA_STREAM_MEM_INCREMENT_MODE = DMA_STREAM_CR_MINC_MSK
...
typedef enum
{
	...
	DMA_STREAM_MEM_BURST_INCR16 = DMA_STREAM_CR_MBURST_MSK
