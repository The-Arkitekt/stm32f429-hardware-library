 ...
 */
const BYTE_TYPE EXTI_1_MIN_PIN = GPIO_PINSELECT_0;
const BYTE_TYPE EXTI_1_MAX_PIN = GPIO_PINSELECT_3;
const BYTE_TYPE EXTI_2_MIN_PIN = GPIO_PINSELECT_4;
const BYTE_TYPE EXTI_2_MAX_PIN = GPIO_PINSELECT_7;
const BYTE_TYPE EXTI_3_MIN_PIN = GPIO_PINSELECT_8;
const BYTE_TYPE EXTI_3_MAX_PIN = GPIO_PINSELECT_11;
const BYTE_TYPE EXTI_4_MIN_PIN = GPIO_PINSELECT_12;
const BYTE_TYPE EXTI_4_MAX_PIN = GPIO_PINSELECT_15;
