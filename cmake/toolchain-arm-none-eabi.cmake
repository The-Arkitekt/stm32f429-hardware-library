...
set(OBJECT_GEN_FLAGS "-O0 -mcpu=${MCU_SPEC} -mthumb -Wall")

set(CMAKE_C_FLAGS   "${OBJECT_GEN_FLAGS} -c -fno-exceptions" CACHE INTERNAL "C Compiler options")
set(CMAKE_CXX_FLAGS "${OBJECT_GEN_FLAGS} -fno-exceptions" CACHE INTERNAL "C++ Compiler options")
